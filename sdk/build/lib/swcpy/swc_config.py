...
class SWCConfig:
    ...
    def __init__(
        ...
        swc_base_url (optional):
            The base URL to use for all the API calls. Pass this in or set in an environment variable
        swc_back_off:
    ...
    def __str__(self):
        """Stringfy function to return contents of config object for logging"""
