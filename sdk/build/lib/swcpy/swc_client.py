...
class SWCClient:
    ...
    GET_COUNT_ENDPOINT = "/v0/counts/"

    BULK_FILE_BASE_URL = (
        "https://raw.githubusercontent.com/[michaelpapi]"
        + "/portfolio-I-project/main/bulk"
    )



    def __init__(self, input_config: config.SWCConfig):
        """Class constructor that sets variables from comnfiguration object."""
    ...
    def get_counts(self) -> Counts:
        ...
        response = self.call_api(self.GET_COUNT_ENDPOINT)
    ...
    def get_bulk_league_file(self) -> bytes:
        """Return a bulk file with league data"""
    ...
    def get_bulk_performance_file(self) -> bytes:
        """Return a bulk file with performance data"""
    ...
    def get_bulk_team_file(self) -> bytes:
        """Return a bulk file with team data"""
    ...
    def get_bulk_team_player_file(self) -> bytes:
        """Return a bulk file with team player data"""
